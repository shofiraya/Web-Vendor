...
<body>
    <div class="navbar bg-neutral">
        ...
        <div class="flex-none">
            <ul class="menu menu-horizontal px-1">
                ...
                <li>
                    <details>
                        <summary><svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <header>
        <h1>Welcome, you're account successfully to be a vendor PT. INKA Multi Solusi</h1>
    </header>
    <nav>
        <ul>
            <hr>
            <li><a href="#permintaan-baru" class="active">Permintaan Baru</a></li>
            <li><a href="#negosiasi">Negosiasi</a></li>
    ...
    <main>
        <section class="request">
            <div class="request-card">
                <h2>PT. INKA Multi Solusi</h2>
                <p>Perusahaan ABC sedang mencari vendor untuk menyediakan jasa pengiriman logistik untuk pengiriman bulan Agustus 2024. Proyek ini mencakup pengiriman barang dari pusat distribusi di Kota A ke pelanggan di wilayah B, C, dan D.</p>
                <div class="buttons">
                    <button class="details-button">Lihat Detail Penawaran</button>
